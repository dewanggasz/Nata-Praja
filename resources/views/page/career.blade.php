        ...
        <section class="hiring">
            <div class="hiring__wrapper">
                ...
                <div class="hiring__content">
                    <a href="/assets/page/career-information/careerInformation_page.html" class="hiring__card">
                        <div class="hiring__card-overlay"></div>
                        <div class="hiring__card-top">
                            <div class="hiring__card-top-left">
                                <h2 class="hiring__card-role">Business Developer</h2>
                                <p>Yogyakarta, Indonesia</p>
                            </div>
                            <div class="hiring__card-top-right">
                                <h5 class="hiring__card-time">Full Time</h5>
                            </div>
                        </div>
                    ...
                    <a href="#" class="hiring__card">
                        <div class="hiring__card-overlay"></div>
                        <div class="hiring__card-top">
                            <div class="hiring__card-top-left">
                                <h2 class="hiring__card-role">Call Center Agent</h2>
                                <p>Yogyakarta, Indonesia</p>
                            </div>
                            <div class="hiring__card-top-right">
                                <h5 class="hiring__card-time">Shifting</h5>
                            </div>
                        </div>
                        <div class="hiring__card-bot">
                            <h4>View & Apply</h4>
                    ...
                    <a href="#" class="hiring__card">
                        ...
                        <div class="hiring__card-top">
                            <div class="hiring__card-top-left">
                                <h2 class="hiring__card-role">General Affair</h2>
                                <p>Yogyakarta, Indonesia</p>
                            </div>
                            <div class="hiring__card-top-right">
                                <h5 class="hiring__card-time">Full Time</h5>
                    ...
                    <a href="#" class="hiring__card">
                        ...
                        <div class="hiring__card-top">
                            <div class="hiring__card-top-left">
                                <h2 class="hiring__card-role">Creative</h2>
                                <p>Yogyakarta, Indonesia</p>
                            </div>
                            <div class="hiring__card-top-right">
                                <h5 class="hiring__card-time">Intern</h5>
                            </div>
                        </div>
                        <div class="hiring__card-bot">
                            <h4>View & Apply</h4>
